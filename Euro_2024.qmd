...
The clash between `r my_teams[[1, 2]]` and `r my_teams[[2, 2]]` in Euro 2024 semifinals is set to be a thrilling and highly anticipated match. Here is a quantitative comparison of both teams.
...
**Scoring dynamics**: comparing the average goals scored and received by each team throughout the tournament.
